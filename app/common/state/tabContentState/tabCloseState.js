...
module.exports.hasFixedCloseIcon = (state, frameKey) => {
  ...
  if (frame == null) {
    console.error('Unable to find frame for hasFixedCloseIcon method')
    return false
  }
...
module.exports.hasRelativeCloseIcon = (state, frameKey) => {
  ...
  if (frame == null) {
    console.error('Unable to find frame for hasRelativeCloseIcon method')
    return false
  }
...
module.exports.showCloseTabIcon = (state, frameKey) => {
  ...
  if (frame == null) {
    console.error('Unable to find frame for showCloseTabIcon method')
    return false
  }
